        ...
        <>
            ...
            >
                    ...
                    <div className=" h-fit p-2  lg:h-lvh w-full lg:w-1/2 flex flex-col flex-wrap justify-start lg:justify-center items-center ">
                        ...
                        <div className="w-full  h-fit bg-white flex justify-center items-center text-base">
                            
                            <div className="px-1  w-full h-full bg-white text-center "> 
                            ...
                            <div className="px-1  w-full h-full bg-white text-center border-x border-black"> 
